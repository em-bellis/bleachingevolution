...
Original code to calculate evolutionary trajectories was shared by Steve J. Arnold during his Evolutionary Quantitative Genetics course at Oregon State.  `evoTraj_noX11.R` is a modified version that does not use X11.  It depicts a simulated evolutionary trajectory for bleaching response in two environments, as shown in Figure 3A.
