...
shinyUI(fluidPage(
  ...
  fluidRow(
    ...
    column(6,
      ...
      p(""),
      p("This plot simulates evolution of coral bleaching response based on a quantitative genetic model that describes phenotypic evolution of a single character expressed in two environments (Via & Lande 1985).  It takes into account direct selection on bleaching responses in Environment 1, as well as a correlated response to selection in Environment 2, which is distinguished by some different stressor or combination of stressors.  Bleaching response is measured as the proportion of symbiotic algae remaining in host tissues after heat stress.  The joint phenotypic optimum is indicated by the '+' and arrowheads are plotted every 10 generations.  Additional information regarding the model parameters can be found in Bellis & Denver (submitted).  Please contact weissem[at]science[dot]oregonstate[dot]edu with suggestions, questions, or comments."),
