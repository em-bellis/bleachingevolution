##This script simulates trajectories of bleaching response evolution over 20 generations based on varied values of omega and theta2.
...
traject <- function(omega1, omega2, theta2) {
...
#run traject function with different values of omega and theta2
df5 <- traject(1,1,0.95)
